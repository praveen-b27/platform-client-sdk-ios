...
| **dateLastActive** | [**Date**](Date.html) | The date of the most recent org activity used for analysis. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd | [optional] |
