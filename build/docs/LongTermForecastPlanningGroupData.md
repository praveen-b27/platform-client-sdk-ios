...
| **offeredPerDay** | **[Double]** | Forecast offered counts per day for this planning group | [optional] |
| **averageHandleTimeSecondsPerDay** | **[Double]** | Forecast average handle time per day in seconds | [optional] |
