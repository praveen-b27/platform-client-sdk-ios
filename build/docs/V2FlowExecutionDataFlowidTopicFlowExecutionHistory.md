...
| **errors** | [**[V2FlowExecutionDataFlowidTopicFlowErrorWarningInfo]**](V2FlowExecutionDataFlowidTopicFlowErrorWarningInfo.html) | If the flow invoked error handling, an array of errors. | [optional] |
| **execution** | [**[V2FlowExecutionDataFlowidTopicExecution]**](V2FlowExecutionDataFlowidTopicExecution.html) | An array of execution items that describe what happened when an Architect flow action container ran such as a flow, task, state or bot. | [optional] |
...
| **warnings** | [**[V2FlowExecutionDataFlowidTopicFlowErrorWarningInfo]**](V2FlowExecutionDataFlowidTopicFlowErrorWarningInfo.html) | If the flow encountered a warning during execution, this is an array of the warnings. | [optional] |
