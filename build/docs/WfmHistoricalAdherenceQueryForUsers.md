...
| **userIds** | **[String]** | The userIds to report on. Note: Only one of [teamIds, userIds] can be requested | |
| **teamIds** | **[String]** | The teamIds to report on. Note: Only one of [teamIds, userIds] can be requested | |
