Platform API version: 7180


# Major Changes (27 changes)

**/api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/agent** (1 change)

* Path /api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/agent was removed

**/api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/queue** (1 change)

* Path /api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/queue was removed

**/api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/external** (1 change)

* Path /api/v2/conversations/calls/{conversationId}/participants/{participantId}/consult/external was removed

**/api/v2/conversations/{conversationId}/participants/{participantId}/replace/agent** (1 change)

* Path /api/v2/conversations/{conversationId}/participants/{participantId}/replace/agent was removed

**/api/v2/conversations/{conversationId}/participants/{participantId}/replace/queue** (1 change)

* Path /api/v2/conversations/{conversationId}/participants/{participantId}/replace/queue was removed

**/api/v2/conversations/{conversationId}/participants/{participantId}/replace/external** (1 change)

* Path /api/v2/conversations/{conversationId}/participants/{participantId}/replace/external was removed
...
* Model ConsultTransferToAgent was removed

**ConsultTransferToQueue** (1 change)

* Model ConsultTransferToQueue was removed

**ConsultTransferToExternal** (1 change)

* Model ConsultTransferToExternal was removed

**TransferToAgentRequest** (1 change)

* Model TransferToAgentRequest was removed

**TransferToQueueRequest** (1 change)

* Model TransferToQueueRequest was removed

**TransferToExternalRequest** (1 change)

* Model TransferToExternalRequest was removed
