...
open class KnowledgeAPI {
  ...
  "published" : true
    ...
    /**
     ...
     - parameter knowledgeBaseId: (path) Knowledge base ID. 
     - parameter contextId: (path) Context ID. 
     - parameter body: (body)  (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func patchKnowledgeKnowledgebaseContext(knowledgeBaseId: String, contextId: String, body: KnowledgeContextRequest? = nil, completion: @escaping ((_ data: KnowledgeContextResponse?,_ error: Error?) -> Void)) {
        let requestBuilder = patchKnowledgeKnowledgebaseContextWithRequestBuilder(knowledgeBaseId: knowledgeBaseId, contextId: contextId, body: body)
        requestBuilder.execute { (response: Response<KnowledgeContextResponse>?, error) -> Void in
            do {
                if let e = error {
                    completion(nil, e)
                } else if let r = response {
  ...
  "id" : "aeiou"
     ...
     - returns: RequestBuilder<KnowledgeContextResponse> 
     */
    open class func patchKnowledgeKnowledgebaseContextWithRequestBuilder(knowledgeBaseId: String, contextId: String, body: KnowledgeContextRequest? = nil) -> RequestBuilder<KnowledgeContextResponse> {
        var path = "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/contexts/{contextId}"
        let knowledgeBaseIdPreEscape = "\(knowledgeBaseId)"
        let knowledgeBaseIdPostEscape = knowledgeBaseIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{knowledgeBaseId}", with: knowledgeBaseIdPostEscape, options: .literal, range: nil)
        ...
        let requestBuilder: RequestBuilder<KnowledgeContextResponse>.Type = PureCloudPlatformClientV2API.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter knowledgeBaseId: (path) Knowledge base ID. 
     - parameter contextId: (path) Context ID. 
     - parameter contextValueId: (path) Context Value ID. 
     - parameter body: (body)  (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func patchKnowledgeKnowledgebaseContextValue(knowledgeBaseId: String, contextId: String, contextValueId: String, body: KnowledgeContextValueRequest? = nil, completion: @escaping ((_ data: KnowledgeContextValueResponse?,_ error: Error?) -> Void)) {
        let requestBuilder = patchKnowledgeKnowledgebaseContextValueWithRequestBuilder(knowledgeBaseId: knowledgeBaseId, contextId: contextId, contextValueId: contextValueId, body: body)
        requestBuilder.execute { (response: Response<KnowledgeContextValueResponse>?, error) -> Void in
            do {
                if let e = error {
                    completion(nil, e)
                } else if let r = response {
  ...
  "id" : "aeiou"
     ...
     - returns: RequestBuilder<KnowledgeContextValueResponse> 
     */
    open class func patchKnowledgeKnowledgebaseContextValueWithRequestBuilder(knowledgeBaseId: String, contextId: String, contextValueId: String, body: KnowledgeContextValueRequest? = nil) -> RequestBuilder<KnowledgeContextValueResponse> {
        var path = "/api/v2/knowledge/knowledgebases/{knowledgeBaseId}/contexts/{contextId}/values/{contextValueId}"
        let knowledgeBaseIdPreEscape = "\(knowledgeBaseId)"
        let knowledgeBaseIdPostEscape = knowledgeBaseIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{knowledgeBaseId}", with: knowledgeBaseIdPostEscape, options: .literal, range: nil)
        let contextIdPreEscape = "\(contextId)"
        let contextIdPostEscape = contextIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{contextId}", with: contextIdPostEscape, options: .literal, range: nil)
        let contextValueIdPreEscape = "\(contextValueId)"
        let contextValueIdPostEscape = contextValueIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{contextValueId}", with: contextValueIdPostEscape, options: .literal, range: nil)
        let URLString = PureCloudPlatformClientV2API.basePath + path
        ...
        let requestBuilder: RequestBuilder<KnowledgeContextValueResponse>.Type = PureCloudPlatformClientV2API.requestBuilderFactory.getBuilder()
