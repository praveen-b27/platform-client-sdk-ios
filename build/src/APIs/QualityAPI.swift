...
open class QualityAPI {
  ...
  "resourceType" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteQualityKeywordset(keywordSetId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        let requestBuilder = deleteQualityKeywordsetWithRequestBuilder(keywordSetId: keywordSetId)
        requestBuilder.execute { (response: Response<Void>?, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func deleteQualityKeywordsetWithRequestBuilder(keywordSetId: String) -> RequestBuilder<Void> {
        var path = "/api/v2/quality/keywordsets/{keywordSetId}"
        let keywordSetIdPreEscape = "\(keywordSetId)"
        let keywordSetIdPostEscape = keywordSetIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{keywordSetId}", with: keywordSetIdPostEscape, options: .literal, range: nil)
        let URLString = PureCloudPlatformClientV2API.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteQualityKeywordsets(ids: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        let requestBuilder = deleteQualityKeywordsetsWithRequestBuilder(ids: ids)
        requestBuilder.execute { (response: Response<Void>?, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func deleteQualityKeywordsetsWithRequestBuilder(ids: String) -> RequestBuilder<Void> {
  ...
  "previousUri" : "aeiou"
    ...
    open class func getQualityConversationAuditsWithRequestBuilder(conversationId: String, pageSize: Int? = nil, pageNumber: Int? = nil, sortBy: String? = nil, expand: [String]? = nil, nextPage: String? = nil, previousPage: String? = nil, recordingId: String? = nil, entityType: String? = nil) -> RequestBuilder<QualityAuditPage> {
        ...
        let requestBuilder: RequestBuilder<QualityAuditPage>.Type = PureCloudPlatformClientV2API.requestBuilderFactory.getBuilder()
  ...
  "previousUri" : "aeiou"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getQualityKeywordset(keywordSetId: String, completion: @escaping ((_ data: KeywordSet?,_ error: Error?) -> Void)) {
        let requestBuilder = getQualityKeywordsetWithRequestBuilder(keywordSetId: keywordSetId)
        requestBuilder.execute { (response: Response<KeywordSet>?, error) -> Void in
            do {
                if let e = error {
                    completion(nil, e)
                } else if let r = response {
    ...
    /**
     ...
     - examples: [{contentType=application/json, example={
  "keywords" : [ {
    "antiPronunciations" : [ "aeiou" ],
    "spotabilityIndex" : 1.3579000000000001069366817318950779736042022705078125,
    "customerScoreModifier" : 123,
    "pronunciation" : "aeiou",
    "confidence" : 123,
    "antiWords" : [ "aeiou" ],
    "agentScoreModifier" : 123,
    "marginOfError" : 1.3579000000000001069366817318950779736042022705078125,
  ...
  "agents" : [ {
    ...
    "geolocation" : {
     ...
     - returns: RequestBuilder<KeywordSet> 
     */
    open class func getQualityKeywordsetWithRequestBuilder(keywordSetId: String) -> RequestBuilder<KeywordSet> {
        var path = "/api/v2/quality/keywordsets/{keywordSetId}"
        let keywordSetIdPreEscape = "\(keywordSetId)"
        let keywordSetIdPostEscape = keywordSetIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{keywordSetId}", with: keywordSetIdPostEscape, options: .literal, range: nil)
        ...
        let requestBuilder: RequestBuilder<KeywordSet>.Type = PureCloudPlatformClientV2API.requestBuilderFactory.getBuilder()
    ...
    public enum Operator_getQualityKeywordsets: String { 
        case and = "AND"
        case or = "OR"
    }
    ...
    /**
     ...
     - parameter queueId: (query) the queue id - used for filtering results in searches. (optional)
     - parameter agentId: (query) the agent id - used for filtering results in searches. (optional)
  ...
  "previousUri" : "aeiou"
    ...
    open class func getQualityKeywordsetsWithRequestBuilder(pageSize: Int? = nil, pageNumber: Int? = nil, sortBy: String? = nil, expand: [String]? = nil, nextPage: String? = nil, previousPage: String? = nil, name: String? = nil, queueId: String? = nil, agentId: String? = nil, _operator: Operator_getQualityKeywordsets? = nil) -> RequestBuilder<KeywordSetEntityListing> {
        ...
        let requestBuilder: RequestBuilder<KeywordSetEntityListing>.Type = PureCloudPlatformClientV2API.requestBuilderFactory.getBuilder()
  ...
  "questionGroups" : [ {
    ...
    /**
     ...
     - parameter body: (body) keywordSet 
     - parameter expand: (query) queueId (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postQualityKeywordsets(body: KeywordSet, expand: String? = nil, completion: @escaping ((_ data: KeywordSet?,_ error: Error?) -> Void)) {
        let requestBuilder = postQualityKeywordsetsWithRequestBuilder(body: body, expand: expand)
        requestBuilder.execute { (response: Response<KeywordSet>?, error) -> Void in
            do {
                if let e = error {
                    completion(nil, e)
  ...
  "agents" : [ {
    ...
    "geolocation" : {
     ...
     - returns: RequestBuilder<KeywordSet> 
     */
    open class func postQualityKeywordsetsWithRequestBuilder(body: KeywordSet, expand: String? = nil) -> RequestBuilder<KeywordSet> {
        let path = "/api/v2/quality/keywordsets"
        let URLString = PureCloudPlatformClientV2API.basePath + path
  ...
  "questionGroups" : [ {
    ...
    /**
     ...
     - parameter body: (body) Keyword Set (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postQualitySpotability(body: KeywordSet? = nil, completion: @escaping ((_ data: KeywordSet?,_ error: Error?) -> Void)) {
        let requestBuilder = postQualitySpotabilityWithRequestBuilder(body: body)
        requestBuilder.execute { (response: Response<KeywordSet>?, error) -> Void in
            do {
                if let e = error {
                    completion(nil, e)
  ...
  "agents" : [ {
    ...
    "geolocation" : {
     ...
     - returns: RequestBuilder<KeywordSet> 
     */
    open class func postQualitySpotabilityWithRequestBuilder(body: KeywordSet? = nil) -> RequestBuilder<KeywordSet> {
        let path = "/api/v2/quality/spotability"
        let URLString = PureCloudPlatformClientV2API.basePath + path
  ...
  "questionGroups" : [ {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func putQualityKeywordset(keywordSetId: String, body: KeywordSet, completion: @escaping ((_ data: KeywordSet?,_ error: Error?) -> Void)) {
        let requestBuilder = putQualityKeywordsetWithRequestBuilder(keywordSetId: keywordSetId, body: body)
        requestBuilder.execute { (response: Response<KeywordSet>?, error) -> Void in
            do {
                if let e = error {
                    completion(nil, e)
  ...
  "agents" : [ {
    ...
    "geolocation" : {
     ...
     - returns: RequestBuilder<KeywordSet> 
     */
    open class func putQualityKeywordsetWithRequestBuilder(keywordSetId: String, body: KeywordSet) -> RequestBuilder<KeywordSet> {
        var path = "/api/v2/quality/keywordsets/{keywordSetId}"
        let keywordSetIdPreEscape = "\(keywordSetId)"
        let keywordSetIdPostEscape = keywordSetIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{keywordSetId}", with: keywordSetIdPostEscape, options: .literal, range: nil)
