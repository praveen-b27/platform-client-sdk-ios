...
public class ConversationCallbackEventTopicErrorBody: Codable {
    ...
    public init(status: Int?, code: String?, entityId: String?, entityName: String?, message: String?, messageWithParams: String?, messageParams: [String:String]?, contextId: String?, details: [ConversationCallbackEventTopicDetail]?, errors: [ConversationCallbackEventTopicErrorBody]?) {
