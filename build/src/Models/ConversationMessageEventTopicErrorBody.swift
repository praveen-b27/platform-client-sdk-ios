...
public class ConversationMessageEventTopicErrorBody: Codable {
    ...
    public init(status: Int?, code: String?, entityId: String?, entityName: String?, message: String?, messageWithParams: String?, messageParams: [String:String]?, contextId: String?, details: [ConversationMessageEventTopicDetail]?, errors: [ConversationMessageEventTopicErrorBody]?) {
