...
public class FacebookIntegration: Codable {
    ...
    public init(_id: String?, name: String?, appId: String?, pageId: String?, status: String?, recipient: UriReference?, dateCreated: Date?, dateModified: Date?, createdBy: UriReference?, modifiedBy: UriReference?, version: Int?, selfUri: String?) {
