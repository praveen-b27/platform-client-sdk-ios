...
public class LearningAssignmentUserListing: Codable {
    ...
    public init(entities: [LearningAssignmentUser]?, pageSize: Int?, pageNumber: Int?, total: Int64?, unfilteredTotal: Int?, firstUri: String?, nextUri: String?, previousUri: String?, selfUri: String?, lastUri: String?, pageCount: Int?) {
