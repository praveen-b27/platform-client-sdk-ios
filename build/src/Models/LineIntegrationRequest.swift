...
public class LineIntegrationRequest: Codable {
    ...
    public init(_id: String?, name: String?, supportedContent: SupportedContentReference?, channelId: String?, channelSecret: String?, switcherSecret: String?, serviceCode: String?, selfUri: String?) {
