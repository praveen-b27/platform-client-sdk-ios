...
public class QueueConversationEventTopicDialerPreview: Codable {
    ...
    public init(_id: String?, contactId: String?, contactListId: String?, campaignId: String?, phoneNumberColumns: [QueueConversationEventTopicPhoneNumberColumn]?, additionalProperties: [String:JSON]?) {
        self._id = _id
