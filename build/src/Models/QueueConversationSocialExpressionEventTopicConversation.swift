...
public class QueueConversationSocialExpressionEventTopicConversation: Codable {
    ...
    public init(_id: String?, maxParticipants: Int?, participants: [QueueConversationSocialExpressionEventTopicParticipant]?, recentTransfers: [QueueConversationSocialExpressionEventTopicRecentTransfer]?, recordingState: String?, address: String?, externalTag: String?) {
        self._id = _id
