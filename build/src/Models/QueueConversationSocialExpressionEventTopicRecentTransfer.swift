//
// QueueConversationSocialExpressionEventTopicRecentTransfer.swift
//
...
public class QueueConversationSocialExpressionEventTopicRecentTransfer: Codable {
    ...
    public init(_id: String?, state: State?, dateIssued: Date?, initiator: QueueConversationSocialExpressionEventTopicInitiator?, destination: QueueConversationSocialExpressionEventTopicDestination?, transferType: TransferType?) {
        self._id = _id
        self.state = state
