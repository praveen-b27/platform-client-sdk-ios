//
// ReschedulingOptionsResponse.swift
//
...
public class ReschedulingOptionsResponse: Codable {
    ...
    public var existingScheduleId: String?
    /** The version of the schedule at the time the rescheduling was initiated */
    public var existingScheduleVersion: Int?

    public init(startDate: Date?, endDate: Date?, agentIds: [String]?, activityCodeIds: [String]?, doNotChangeWeeklyPaidTime: Bool?, doNotChangeDailyPaidTime: Bool?, doNotChangeShiftStartTimes: Bool?, doNotChangeManuallyEditedShifts: Bool?, existingScheduleId: String?, existingScheduleVersion: Int?) {
        ...
        self.existingScheduleVersion = existingScheduleVersion
