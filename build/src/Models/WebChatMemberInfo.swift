...
public class WebChatMemberInfo: Codable {
    ...
    public init(_id: String?, displayName: String?, avatarImageUrl: String?, role: Role?, joinDate: Date?, leaveDate: Date?, authenticatedGuest: Bool?, customFields: [String:String]?, state: State?) {
